...
EngineRoot = $(LOCAL_PATH)/../../../../
Classes = $(LOCAL_PATH)/../../../Classes/
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../lib $(LOCAL_PATH)/../lib/protobuf-lite
LOCAL_C_INCLUDES += $(EngineRoot)cocos\
LOCAL_C_INCLUDES += $(EngineRoot)cocos/editor-support\
LOCAL_C_INCLUDES += $(EngineRoot)cocos/platform/android\
$(EngineRoot)external
