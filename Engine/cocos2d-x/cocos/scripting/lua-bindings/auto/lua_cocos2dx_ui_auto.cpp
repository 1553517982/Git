...
int AddButtonOnClick(lua_State * L)
{
	LUA_FUNCTION handler = (toluafix_ref_function(L, 1, 0));

	cocos2d::ui::Button::SetOnClick([=]()
	{
...
int lua_register_cocos2dx_ui_Button(lua_State* tolua_S)
{
	...
	lua_pushcfunction(tolua_S, AddButtonOnClick);
	lua_setglobal(tolua_S, "AddButtonOnClick");
...
int lua_cocos2dx_ui_RichText_setDimensions(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichText_setDimensions'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2)
    {
		double arg0;
		double arg1;
        ok &= luaval_to_number(tolua_S, 2,&arg0, "ccui.RichText:setDimensions");
        ok &= luaval_to_number(tolua_S, 3, &arg1, "ccui.RichText:setDimensions");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichText_setDimensions'", nullptr);
            return 0;
        }
		cobj->setDimensions(float(arg0), float(arg1));
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichText:setDimensions",argc, 6);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichText_setDimensions'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichText_getDimensions(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichText:getDimensions",argc, 6);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichText_getDimensions'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_ui_RichText(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichText");
        ...
        tolua_function(tolua_S,"setDimensions",lua_cocos2dx_ui_RichText_setDimensions);
        tolua_function(tolua_S,"getDimensions",lua_cocos2dx_ui_RichText_getDimensions);
...
int lua_cocos2dx_ui_Scale9Sprite_initWithPlistUnit(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::ui::Scale9Sprite* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_ui_Scale9Sprite_initWithPlistUnit'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 2)
	{
		...
		ok &= luaval_to_std_string(tolua_S, 2, &arg0, "ccui.Scale9Sprite:initWithPlistUnit");
		ok &= luaval_to_int32(tolua_S, 3, &arg1, "ccui.Scale9Sprite:initWithPlistUnit");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_ui_Scale9Sprite_initWithPlistUnit'", nullptr);
			return 0;
		}
		bool bRet = cobj->initWithPlistUnit(arg0, arg1);
		tolua_pushboolean(tolua_S, bRet);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Scale9Sprite:initWithPlistUnit", argc, 2);
	return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_ui_Scale9Sprite_initWithPlistUnit'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Scale9Sprite(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Scale9Sprite");
		...
		tolua_function(tolua_S, "initWithPlistUnit", lua_cocos2dx_ui_Scale9Sprite_initWithPlistUnit);
