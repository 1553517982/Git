...
/*
FileStream::FileStream(const char* lpFileName, unsigned int dwAccessType)
{
...
FileStream::FileStream(const char* lpFileName, unsigned int dwAccessType, OpenDisposition eWin32CreateionDisposition)
{
