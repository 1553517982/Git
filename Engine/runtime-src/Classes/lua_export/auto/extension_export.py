...
def main():
    ...
    try:
        ...
        cmd_args = {'gamecore_scene.ini' : ('scene', 'lua_gamecore_scene_auto') \
					,'gamecore_ccsext.ini' : ('ccsext', 'lua_gamecore_ccsext_auto')\
					,'gamecore_helpers.ini' : ('helpers', 'lua_gamecore_helpers_auto')\
					,'gui_common.ini' : ('guiex', 'lua_gui_common_auto')\
					}
