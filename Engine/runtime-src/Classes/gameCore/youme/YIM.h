...
public:
	...
	//设置语音识别方言，语言
	virtual YIMErrorcode SetSpeechRecognizeParam(SpeechAccent accent = ACCENT_MANDARIN, SpeechRecognizeLanguage language = RECOGNIZELANG_ZH_CH) = 0;
